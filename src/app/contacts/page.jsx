    ...
    return (       
        ...
        <div className={styles.pageContact}>  
            ...
            <div className={styles.head}>      
                <GoHome/>
                <div></div>
                <Image className={styles.image} src="/МГС Инж.png" alt="МГС" width={140} height={160}/>                    
            </div>    
            <h1>КОНТАКТЫ</h1>
            ...
            <div className={styles.mapsAndTel}>
                ...
                <div>
                    ...
                    <a href="https://yandex.ru/maps/?um=constructor%3A64c2cc8b5387373147ae9ca99c7fdc4a7c95c8ca33ed8fa826dce5f076d44534&amp;source=constructorStatic" target="_blank"><img src="https://api-maps.yandex.ru/services/constructor/1.0/static/?um=constructor%3A64c2cc8b5387373147ae9ca99c7fdc4a7c95c8ca33ed8fa826dce5f076d44534&amp;width=600&amp;height=450&amp;lang=ru_RU" alt="maps...loading..." style={{borderRadius: '15px'}} /></a>
                    </div>
                </div>
            </div> 

            <footer className={styles.footer} style={{color:"black"}}>
